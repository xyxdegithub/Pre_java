...
<div id="main">
    <div class="navigation">
        当前位置:审核图书页面&nbsp;&nbsp;跳转:&nbsp;&nbsp;<a href="/admin?method=getCheckedBorrowed&page=1">审核通过被借走的书籍页面</a>
    ...
    <table class="table" cellspacing="0">
        ...
        <c:forEach items="${list}" var="borrow">
            <tr>
                ...
                <td>
                    <a href="/admin?method=check&id=${borrow.id}&state=1">同意借书</a>
                    <a href="/admin?method=check&id=${borrow.id}&state=2">拒绝借书</a>
                </td>
            </tr>
        </c:forEach>
    ...
    <hr class="hr"/>
    <div id="pageControl">
        <div class="pageControl_item">每页规定最多<font id="dataPrePage">${dataPrePage }</font>条数据</div>
