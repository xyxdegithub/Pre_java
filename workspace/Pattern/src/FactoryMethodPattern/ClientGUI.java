...
public class ClientGUI extends JFrame{
    ...
    public static final String BODYINJURE = "人身伤害保险";
    public static final String COLLISION = "碰撞伤害保险";
    public static final String PERSONINJURE = "个人伤害保险";
    public static final String COMPREHENSIVE = "综合伤害保险";
    public static final String LuxuryCarInjur="这是车伤害保险";
 ...
 private void setUpScrollPanes() {
    ...
    txtForInfo.setBackground(Color.white);
