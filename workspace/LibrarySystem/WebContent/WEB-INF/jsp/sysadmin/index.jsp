...
<body>
	...
	<div class="header">
		<div class="dl-title">
			<img src="${pageContext.request.contextPath }/assets/img/logo.png"
				style="height: 30px;"> 图书馆管理系统 <span>Library Management
				System</span>
		</div>
		<div class="dl-log">
			欢迎您：<span class="dl-log-user">${sysAdmin.uname }</span><a
				href="<%=request.getContextPath()%>/sysadmin/quit" title="退出系统"
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/assets/js/common/main-min.js"></script>
	<script type="text/javascript"
