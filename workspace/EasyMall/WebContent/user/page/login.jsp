...
<html>
<head lang="en">
	<!-- 通知浏览器在基于相对路径生成绝对路径时，以此作为父路径 -->
	<base href="http://localhost:8080/EasyMall/user/page/">
    <meta charset="UTF-8">
    <title>达内商城学子登录页面</title>
...
<div id="container">
    <div id="cover" class="rt">
        <form id="fm-login" name="form1" method="post" action="/EasyMall/login" >
            <div class="txt">
                <p>登录学子商城
                    <span>
                ...
                <div class="text">
                    <input type="text" placeholder="请输入您的用户名" name="username" id="uname"
                    value='<%=request.getParameter("username")==null?"":request.getParameter("username") %>' >
                    <span></span>
                </div>

                <div class="text">
                    <input type="password" id="upwd" placeholder="请输入您的密码" name="password">
                    <span></span>
                </div>
                <div class="chose">
...
<!--错误提示-->
<div id="showResult" style='color:red'>
	<%=
